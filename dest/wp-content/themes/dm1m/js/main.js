...
},{"gsap":3,"jquery-slim":5}],9:[function(require,module,exports){
'use strict';
...
$(function () {
    ...
    var moreSheepBox = require('./moreSheepBox.js');
...
},{"./animSheep.js":6,"./burger.js":7,"./gridHover.js":8,"./methodo.js":10,"./moreSheepBox.js":11,"./mosaic.js":12,"./rolloverMenu.js":14,"./slider.js":15,"./smallCloudAnimation.js":16,"gsap":3,"is-mobile":4,"jquery-slim":5}],10:[function(require,module,exports){
'use strict';
...
var $ = require('jquery-slim');
require('gsap');
var CSSRulePlugin = require('gsap/CSSRulePlugin');
var requestAnimFrame = require('./requestAnimFrame.js');
var throttle = require('./throttle.js');
...
},{"./requestAnimFrame.js":13,"./throttle.js":17,"gsap":3,"gsap/CSSRulePlugin":1,"jquery-slim":5}],12:[function(require,module,exports){
'use strict';
...
module.exports = function (grid) {
  ...
  function handleResize() {
    var desktopSmall = 960;
    var phone = 580;
    var gridLayout = void 0;

    if ($(window).width() > desktopSmall) {
      gridLayout = ['square', 'v-rect', 'square', 'square', 'h-rect', 'v-rect', 'v-rect', 'square', 'square', 'h-rect', 'square', 'square'];
    } else if ($(window).width() < desktopSmall && $(window).width() >= phone) {
      gridLayout = ['square', 'square', 'square', 'square', 'h-rect', 'square', 'square', 'square', 'v-rect', 'square', 'v-rect', 'square'];
    } else if ($(window).width() < phone) {
      gridLayout = ['square', 'square', 'square', 'square', 'square', 'square', 'square', 'square', 'square', 'square', 'square', 'square'];
    }
    return gridLayout;
  }

  function loadImgAsync(index, type, img) {
    var imgParsed = JSON.parse(img);
  ...
  function selectImgKind(gridLayout) {
    grid.find('.js-grid-item').each(function (index) {
      var squareImg = $(this).data('square-img');
      var vRectImg = $(this).data('v-rect-img');
      var hRectImg = $(this).data('h-rect-img');

      var layoutIndex = index % 12;
  ...
  var gridLayout = handleResize();
  selectImgKind(gridLayout);

  $(window).on('resize', throttle(function () {
    requestAnimFrame(function () {
      var gridLayoutUpdate = handleResize();
...
},{"./requestAnimFrame.js":13,"./throttle.js":17,"jquery-slim":5}],13:[function(require,module,exports){
"use strict";
...
},{"gsap":3,"jquery-slim":5}],16:[function(require,module,exports){
'use strict';
